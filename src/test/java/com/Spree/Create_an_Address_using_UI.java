...
public class Create_an_Address_using_UI {
...
String fname;
	...
	public void login() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id='spree_user_email']")).sendKeys("elena@spree.com");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@name='spree_user[password]']")).sendKeys("Elena123");
		Thread.sleep(2000);
